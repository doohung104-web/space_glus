...
ANSWER_LIST = [
    ...
    "Sure, [SCORE].",
    "Sure, it is [SCORE].",
    "Sure, the prediction result is [SCORE].",
]
...
UNIFIED_SHORT_QUESTION_LIST = [
    "Reference Video: " + DEFAULT_VIDEO_TOKEN + " \n"
    "Target Image: " + DEFAULT_IMAGE_TOKEN + " \n"
    "Does the Target Image provide enough information for localizing and segmenting the {sent} in the Reference Video? Please respond with a confidence score.",
    "Reference Video: " + DEFAULT_VIDEO_TOKEN + " \n"
    "Target Image: " + DEFAULT_IMAGE_TOKEN + " \n"
    "Does the Target Image provide enough information for localizing and segmenting the {sent} in the Reference Video? Please output confidence score.",
]

UNIFIED_LONG_QUESTION_LIST = [
    "Reference Video: " + DEFAULT_VIDEO_TOKEN + " \n"
    "Target Image: " + DEFAULT_IMAGE_TOKEN + " \n"
    "Please decide whether the Target Image provide enough information for localizing and segmenting the {sent} in the Reference Video.",
]
