...
if __name__ == '__main__':
    ...
    parser.add_argument("--mevis_exp_path", type=str, help="path to ref-davis17 valid/meta_expression.json")
    parser.add_argument("--mevis_mask_path", type=str, help="path to ref-davis 17 valid/mask_dict.pkl")
