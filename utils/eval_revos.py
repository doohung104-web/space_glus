...
if __name__ == '__main__':
    ...
    parser.add_argument("--visa_pred_path", type=str, help="path to predicted masks")
    parser.add_argument("--visa_exp_path", type=str, help="path to ReVOS/meta_expressions_valid_.json")
    parser.add_argument("--visa_mask_path", type=str, help="path to ReVOS/mask_dict.json")
    parser.add_argument("--visa_foreground_mask_path", type=str, help="path to ReVOS/mask_dict_foreground.json")
